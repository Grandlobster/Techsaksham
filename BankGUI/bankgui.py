...
class BankingSystem:
    def __init__(self, root):
        ...
        self.acc_num_label = tk.Label(self.create_account_frame, text="Account Number:")
        ...
        self.acc_holder_label = tk.Label(self.create_account_frame, text="Account Holder:")
        ...
        self.initial_balance_label = tk.Label(self.create_account_frame, text="Initial Balance:")
        ...
        self.trans_acc_num_label = tk.Label(self.transaction_frame, text="Account Number:")
        ...
        self.info_acc_num_label = tk.Label(self.info_frame, text="Account Number:",font="Roman",fg="green",bg="yellow")
        ...
        self.info_button = tk.Button(self.info_frame, text="Display Info", command=self.display_info)
